...
if __name__ == "__main__":
    ...
    crossover_probability = np.array([0.1266, 0.2649, 0.6482, 0.4757])
    crossover_repair = np.array(["round", "bounds", "bounds", "round"])
    crossover_distribution_index = np.array([324.0252, 105.8977, 242.0234, None])
    blx_alpha_crossover = np.array([None, None, None,0.1367])
    mutation = np.array(["uniform", "uniform", "uniform", "uniform"])
    mutation_probability= np.array([0.2397, 0.2211, 0.1227, 0.1197])
    mutation_repair = np.array(["random","round","bounds","round"])
    polinomial_mut_dist_index = np.array([None, None, None,None])
    uniform_mut_perturbation = np.array([0.444, 0.5050, 0.8183, 0.6088])
    selection = np.array(["tournament","random","random","random"])
    tournament_size = np.array([5,None,None,None])
