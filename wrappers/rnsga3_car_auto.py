...
if __name__ == "__main__":
    ...
    crossover= "SBX"
    crossover_probability = 0.6180
    crossover_repair = "bounds"
    crossover_distribution_index = 398.5360 
    blx_alpha_crossover = None,
    mutation = "uniform"
    mutation_probability= 0.0259
    mutation_repair = "round"
    polinomial_mut_dist_index = None
    uniform_mut_perturbation = 0.7061
    ...
    for k in range(0,30):
        ...
        #print(result)
    file_name = f'Results_for_Car_RNSGA3_opt'
