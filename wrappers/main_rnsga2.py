...
def main(SEED, PROB, ID, OBJ, RP, POP, GENS, CROS, CROS_PROB, CROS_REP, CROS_DIST, CROS_ALPHA, MUT, MUT_PROB, MUT_REPAIR, MUT_PMD, MUT_UMP, SEL, SEL_SIZE, NORM, EXT_REF, EPS):
...
if __name__ == "__main__":
    ...
    main(args.seed, args.prob, args.id, args.obj, args.rp, args.pop, args.gens, args.cros,args.cros_prob, args.cros_rep, args.cros_dist, args.cros_alpha, args.mut, args.mut_prob, args.mut_repair, args.mut_pmd, args.mut_ump, args.sel, args.sel_size, args.norm, args.ext_ref, args.eps)
