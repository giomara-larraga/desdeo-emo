...
if __name__ == "__main__":
    ...
    file_path = '/home/giomara/WCCI2024/desdeo-emo/wrappers/data_default_parameters_dominated.csv'
    ...
    for row in csv_data:
        ...
        if objectives == 3:     
            crossover= "SBX"
            crossover_probability = 0.598
            crossover_repair = "random"
            crossover_distribution_index = 153.1081
            blx_alpha_crossover = None
            mutation = "uniform"
            mutation_probability= 0.1012
            mutation_repair = "bounds"
            polinomial_mut_dist_index = None
            uniform_mut_perturbation = 0.6572
            selection = "random"
            tournament_size = None
        elif objectives == 5:
            crossover= "BLX_ALPHA"
            crossover_probability = 0.4346
            crossover_repair = "bounds"
            crossover_distribution_index = None
            blx_alpha_crossover = 0.8404
            mutation = "uniform"
            mutation_probability= 0.193
            mutation_repair = "bounds"
            polinomial_mut_dist_index = None
            uniform_mut_perturbation = 0.6669
            selection = "random"
            tournament_size = None
        else:
            crossover= "BLX_ALPHA"
            crossover_probability = 0.9196
            crossover_repair = "bounds"
            crossover_distribution_index = None
            blx_alpha_crossover = 0.5856
            mutation = "polynomial"
            mutation_probability= 0.3843
            mutation_repair = "bounds"
            polinomial_mut_dist_index = 0.3843
        ...
        for k in range(0,10):
            ...
            result = run(problem, id_prob, objectives, ref_point, generations, None, mu, selection, tournament_size, crossover, crossover_probability, blx_alpha_crossover, crossover_distribution_index, crossover_repair, mutation, mutation_probability, mutation_repair, uniform_mut_perturbation, polinomial_mut_dist_index)
            results.append(result)
        file_name = f'Results_irace_for_{problem_name}_{objectives}_achievable'
