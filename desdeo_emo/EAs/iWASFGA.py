...
from desdeo_emo.selection.iWASFGA_select import iWASFGA_select
from desdeo_problem import MOProblem


class iWASFGA(BaseDecompositionEA):
    """Python Implementation of iWASFGA. Based on the jmetal implementation.
    ...
    def __init__(
        ...
        selection_operator = iWASFGA_select(
